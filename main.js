...
function WiggleButtons() {
  ...
  button[1].style.transform = "rotate(1deg)";
  button[2].style.transform = "rotate(-1deg)";
  button[3].style.transform = "rotate(1deg)";
...
function Action(i) {
  ...
  if (lineWidth > 5)
    colocoSettings = [0, 1, 2, 1, 2, 3, 2, 2, 2, 3, 1, 2, 4, 1, 2, 1, 1, 2];
